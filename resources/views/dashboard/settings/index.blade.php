                ...
                <div class="card-body">
                    <div class="fancy-table table-responsive rounded">
                        <table class="table table-striped mb-0">
                            <thead>
                                <tr>
                                    <th scope="col">أسم العياده</th>
                                    <th scope="col">الهاتف</th>
                                    <th scope="col">العنوان</th>
                                    <th scope="col">البريد الالكترونى</th>
                                    <th scope="col">ساعات العمل من</th>
                                    <th scope="col">ساعات العمل الى</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex align-items-center list-user-action">
                                            <a class="text-success pe-2" data-bs-toggle="tooltip" data-placement="top"
                                                title="" data-original-title="Add" href="#">
                                            ...
                                            <a class="text-warning pe-2" data-bs-toggle="tooltip" data-placement="top"
                                            ...
                                            <a class="text-danger" data-bs-toggle="tooltip" data-placement="top"
