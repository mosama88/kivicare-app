...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('dashboard') }}/assets/css/core/libs.min.css" />

    <!-- flaticon css -->
    <link rel="stylesheet" href="{{ asset('dashboard') }}/assets/vendor/flaticon/css/flaticon.css" />

    <!-- font-awesome css -->
    <link rel="stylesheet" href="{{ asset('dashboard') }}/assets/vendor/font-awesome/css/all.min.css" />

    <!-- Flatpickr css -->
    <link rel="stylesheet" href="{{ asset('dashboard') }}/assets/vendor/flatpickr/dist/flatpickr.min.css" />

    <link rel="stylesheet" href="{{ asset('dashboard') }}/assets/vendor/sheperd/dist/css/sheperd.css">
    ...
    <link rel="stylesheet" href="{{ asset('dashboard') }}/assets/css/kivicare.min.css?v=1.4.1" />

    <!-- Custom Css -->
    <link rel="stylesheet" href="{{ asset('dashboard') }}/assets/css/custom.min.css?v=1.4.1" />

    <!-- RTL Css -->
    <link rel="stylesheet" href="{{ asset('dashboard') }}/assets/css/rtl.min.css?v=1.4.1" />

    <!-- Customizer Css -->
    <link rel="stylesheet" href="{{ asset('dashboard') }}/assets/css/customizer.min.css?v=1.4.1" />
...
<body class="  ">
    ...
    <aside class="sidebar sidebar-base " id="first-tour" data-toggle="main-sidebar" data-sidebar="responsive">
        <div class="sidebar-header d-flex align-items-center justify-content-start position-relative">
            <a href="./index.html" class="navbar-brand">
                ...
                <!--Logo start-->
                <div class="logo-main">
                    <img class="logo-normal img-fluid" src="{{ asset('dashboard') }}/assets/images/logo.png"
                        height="30" alt="logo">
                    <img class="logo-normal dark-normal img-fluid"
                        src="{{ asset('dashboard') }}/assets/images/logo-dark.png" height="30" alt="logo">
        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#dashboard" role="button"
                            aria-expanded="false">
                        ...
                        <ul class="sub-nav collapse" id="dashboard" data-bs-parent="#sidebar-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " aria-current="page" href="./patient-dashboard.html">
                                    <i class="icon" data-bs-toggle="tooltip" title="Dashboard"
                                        data-bs-placement="right">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " aria-current="page" href="./appointment.html">
                            <i class="icon" data-bs-toggle="tooltip" title="Appointment"
                                data-bs-placement="right">
                                <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <li class="nav-item">
                        <a class="nav-link " aria-current="page" href="./doctors.html">
                            ...
                            <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Doctors"
                                data-bs-placement="right">DR</i>
                            <span class="item-name">Doctors</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " aria-current="page" href="./patient.html">
                            ...
                            <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Patient"
                                data-bs-placement="right">P</i>
                            <span class="item-name">Patient</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " aria-current="page" href="./category.html">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " aria-current="page" href="./payment.html">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " aria-current="page" href="./helpsupport.html">
                            <i class="icon" data-bs-toggle="tooltip" title="Help & Support"
                                data-bs-placement="right">
                                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4"
                    ...
                    <li class="nav-item">
                        <a class="nav-link " aria-current="page" href="./setting.html">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " aria-current="page" href="./component.html">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " aria-current="page" href="./ui-color.html">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#auth-skins" role="button"
                            aria-expanded="false">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="./app/user-add.html">
                                    ...
                                    <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="User Add"
                        ...
                        <ul class="sub-nav collapse" id="utilities-error" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="./errors/maintenance.html">
                                    ...
                                    <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Maintenance"
                                        data-bs-placement="right"> M
                                    </i>
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="./errors/error404.html">
                                    ...
                                    <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Error 404"
                                        data-bs-placement="right"> 404
                                    </i>
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="./errors/error500.html">
                                    ...
                                    <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Error 500"
                                        data-bs-placement="right"> 500
                                    </i>
            ...
            <nav class="nav navbar navbar-expand-xl navbar-light iq-navbar">
                <div class="container-fluid navbar-inner">
                    <a href="./index.html" class="navbar-brand">
                        ...
                        <div class="logo-main">
                            <img class="logo-normal img-fluid"
                                src="{{ asset('dashboard') }}/assets/images/logo.png" height="30"
                                alt="logo">
                            <img class="logo-normal dark-normal img-fluid"
                                src="{{ asset('dashboard') }}/assets/images/logo-dark.png" height="30"
                                alt="logo">
                            <img class="logo-normal white-normal img-fluid"
                                src="{{ asset('dashboard') }}/assets/images/logo-white.png" height="30"
                                alt="logo">
                            <img class="logo-mini img-fluid"
                                src="{{ asset('dashboard') }}/assets/images/logo-mini.png" height="30"
                                alt="logo">
                            <img class="logo-mini dark-mini img-fluid"
                                src="{{ asset('dashboard') }}/assets/images/logo-mini-dark.png" height="30"
                                alt="logo">
                            <img class="logo-mini white-mini img-fluid"
                                src="{{ asset('dashboard') }}/assets/images/logo-mini-white.png" height="30"
                                alt="logo">
                        </div>
                        <!--logo End-->
                    </a>
                                        ...
                                        <ul class="iq-header-sub-menu list-unstyled collapse" id="allPagesData">
                                            ...
                                            <li class="nav-item">
                                                ...
                                                <ul aria-expanded="false"
                                                    ...
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="./auth/recoverpw.html">Reset
                                                            Password</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                    ...
                    <div class="d-flex align-items-center">
                        <button id="navbar-toggle" class="navbar-toggler px-0" type="button"
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                            <li class="nav-item dropdown me-0 me-xl-3">
                                <div class="d-flex align-items-center mr-2 iq-font-style" role="group"
                                    ...
                                    <label for="font-size-sm" class="btn btn-border border-0 btn-icon btn-sm"
                                        data-bs-toggle="tooltip" title="Font size 14px"
                                    ...
                                    <label for="font-size-md" class="btn btn-border border-0 btn-icon"
                                        data-bs-toggle="tooltip" title="Font size 16px"
                                        data-bs-placement="bottom">
                                    ...
                                    <label for="font-size-lg" class="btn btn-border border-0 btn-icon"
                                        data-bs-toggle="tooltip" title="Font size 18px"
                                        data-bs-placement="bottom">
                            ...
                            <li class="nav-item dropdown">
                                <a href="#" class="nav-link" id="notification-drop"
                                    ...
                                    <div class="nav-list-icon">
                                        <div class="btn-inner">
                                            <svg class="icon-20" width="19" height="22"
                            ...
                            <li class="nav-item dropdown">
                                <a href="#" class="nav-link" id="notification-cart"
                                    data-bs-toggle="dropdown">
                                    <div class="btn-action position-relative nav-list-icon">
                                        <span class="btn-inner">
                                            <svg class="cart-icons icon-20" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <a href="#" class="nav-link" id="btnFullscreen" data-bs-toggle="dropdown">
                                    <div class="icon nav-list-icon">
                                        <span class="btn-inner">
                                            ...
                                            <svg class="full-normal-screen d-none icon-20" width="24"
        ...
        <div class="content-inner container-fluid pb-0" id="page_layout">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="d-flex align-items-center justify-content-between flex-sm-row flex-column-reverse">
                        ...
                        <div>
                            <img class="img-fluid"
                                src="{{ asset('dashboard') }}/assets/images/dashboard/dr-dashboard.png"
                                ...
                                <div class="card-body pb-0">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="dropdown lh-1">
                                            <span role="button" id="dropdownMenuTodayAppointment"
                                                data-bs-toggle="dropdown" aria-expanded="false">
                                                <svg width="3" height="20" viewBox="0 0 5 20"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        <h3 class="text-primary d-inline-block counter mb-0"
                                            style="visibility: visible;">50</h3>
                                        <span
                                            class="badge rounded-pill bg-success-subtle text-success p-2">+25.2%</span>
                                    </div>
                                </div>
                                <div class="card-bg position-relative mt-2">
                                    <img class="img-fluid float-end"
                                        src="{{ asset('dashboard') }}/assets/images/dashboard/finance.png"
                            ...
                            <div class="card card-block card-stretch card-height overflow-hidden">
                                <div class="card-body pb-0">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="dropdown lh-1">
                                            <span role="button" id="dropdownMenuTotalPatients"
                                                data-bs-toggle="dropdown" aria-expanded="false">
                                                <svg width="3" height="20" viewBox="0 0 5 20"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg"
                                                    style="transform: rotate(90deg);">
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        <h3 class="text-primary d-inline-block counter mb-0"
                                            style="visibility: visible;">20M</h3>
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-3">
                            ...
                            <div class="dropdown text-end f-none">
                                <button class="dropdown btn btn-light-subtle border text-body py-2 px-3"
                                    id="dropdownMenuAppointmentToday" data-bs-toggle="dropdown"
                                    aria-expanded="false">
                                    <span class="fw-500">Today</span>
                                    <svg width="8" class="ms-1 transform-up" viewBox="0 0 12 8"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <div class="row">
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="dropdown text-end">
                                        <button class="dropdown btn btn-light-subtle border text-body py-2 px-3"
                                            id="dropdownMenuRevenue" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div
                            class="card-header d-flex align-items-center justify-content-between flex-wrap gap-3 mb-3">
                            <h4 class="mb-0">Available Doctors</h4>
                            <div class="dropdown text-end">
                                <button class="dropdown btn border-0 p-0" id="dropdownMenuAvailableDoc"
                                    data-bs-toggle="dropdown" aria-expanded="false">
                                    <span class="fw-500 d-inline-block align-middle">View All</span>
                                    <svg width="14" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg" class="transform-icon transform-down">
                                        <path d="M8.5 5L15.5 12L8.5 19" stroke="currentColor" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                    </svg>
                                </button>
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-3">
                            ...
                            <div class="dropdown text-end">
                                <button class="dropdown btn border-0 p-0" id="dropdownMenuTransaction"
                                    data-bs-toggle="dropdown" aria-expanded="false">
                                    <span class="fw-500 d-inline-block align-middle">View All</span>
                                    <svg width="14" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg" class="transform-icon transform-down">
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-3">
                            ...
                            <div class="dropdown text-end">
                                <button class="dropdown btn border-0 p-0" id="dropdownMenuAppReq"
                                    data-bs-toggle="dropdown" aria-expanded="false">
                                    <span class="fw-500 d-inline-block align-middle">View All</span>
                                    <svg width="14" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg" class="transform-icon transform-down">
        ...
        <footer class="footer">
            <div class="footer-body">
                <ul class="left-panel list-inline mb-0 p-0">
                    ...
                    <li class="list-inline-item fw-500"><a class="footer-link"
                            href="./extra/terms-of-service.html">Terms of Use</a></li>
                </ul>
                <h6 class="right-panel mb-0">
                    ©
                    <script>
                        document.write(new Date().getFullYear())
                    </script> <span data-setting="app_name">KiviCare</span> with
    ...
    <div class="offcanvas offcanvas-end live-customizer" tabindex="-1" id="live-customizer"
        ...
        <div class="offcanvas-header">
            ...
            <div class="d-flex gap-2 align-items-center">
                <button class="btn btn-primary p-2" data-copy="settings" data-bs-toggle="tooltip"
                                ...
                                <div class="d-grid gap-3 grid-cols-2 mb-4">
                                    <div data-setting="attribute" class="text-center">
                                        ...
                                        <label class="btn btn-border d-block p-0" for="theme-scheme-direction-ltr">
                                            <img src="{{ asset('dashboard') }}/assets/images/settings/dark/01.png"
                                                alt="ltr" class="mode dark-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                            <img src="{{ asset('dashboard') }}/assets/images/settings/light/01.png"
                                    ...
                                    <div data-setting="attribute" class="text-center">
                                        ...
                                        <label class="btn btn-border d-block p-0" for="theme-scheme-direction-rtl">
                                            <img src="{{ asset('dashboard') }}/assets/images/settings/dark/02.png"
                                                alt="ltr" class="mode dark-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                            <img src="{{ asset('dashboard') }}/assets/images/settings/light/02.png"
                                                alt="ltr" class="mode light-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                        </label>
                                ...
                                <div class="d-grid gap-3 grid-cols-4 mb-4">
                                    <div data-setting="checkbox" class="text-center">
                                        ...
                                        <label class="btn btn-border p-0 d-block overflow-hidden"
                                            for="sidebar-mini">
                                            <img src="{{ asset('dashboard') }}/assets/images/settings/dark/03.png"
                                                alt="mini" class="mode dark-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                            <img src="{{ asset('dashboard') }}/assets/images/settings/light/03.png"
                                    ...
                                    <div data-setting="checkbox" class="text-center">
                                        ...
                                        <label class="btn btn-border p-0 d-block overflow-hidden"
                                            for="sidebar-hover">
                                            <img src="{{ asset('dashboard') }}/assets/images/settings/dark/04.png"
                                                alt="hover" class="mode dark-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                            <img src="{{ asset('dashboard') }}/assets/images/settings/light/04.png"
                                    ...
                                    <div data-setting="checkbox" class="text-center">
                                        ...
                                        <label class="btn btn-border p-0 d-block overflow-hidden"
                                            for="sidebar-boxed">
                                            <img src="{{ asset('dashboard') }}/assets/images/settings/dark/05.png"
                                                alt="boxed" class="mode dark-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                            <img src="{{ asset('dashboard') }}/assets/images/settings/light/05.png"
                            ...
                            <div>
                                ...
                                <div class="d-grid gap-3 grid-cols-3 mb-4">
                                    <div data-setting="radio" class="text-center">
                                        ...
                                        <label class="btn btn-border p-0 d-block overflow-hidden"
                                            for="navs-rounded">
                                            <img src="{{ asset('dashboard') }}/assets/images/settings/dark/06.png"
                                                alt="mini" class="mode dark-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                            <img src="{{ asset('dashboard') }}/assets/images/settings/light/06.png"
                                                alt="mini" class="mode light-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                        </label>
                                    ...
                                    <div data-setting="radio" class="text-center">
                                        ...
                                        <label class="btn btn-border p-0 d-block overflow-hidden"
                                            ...
                                            <img src="{{ asset('dashboard') }}/assets/images/settings/dark/07.png"
                                                alt="hover" class="mode dark-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                            <img src="{{ asset('dashboard') }}/assets/images/settings/light/07.png"
                                                alt="hover" class="mode light-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                        </label>
                                    ...
                                    <div data-setting="radio" class="text-center">
                                        ...
                                        <label class="btn btn-border p-0 d-block overflow-hidden" for="navs-pill">
                                            <img src="{{ asset('dashboard') }}/assets/images/settings/dark/08.png"
                                                alt="boxed" class="mode dark-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                            <img src="{{ asset('dashboard') }}/assets/images/settings/light/08.png"
                                                alt="boxed" class="mode light-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                        </label>
                                    ...
                                    <div data-setting="radio" class="text-center">
                                        ...
                                        <label class="btn btn-border p-0 d-block overflow-hidden"
                                            for="navs-pill-all">
                                            <img src="{{ asset('dashboard') }}/assets/images/settings/dark/09.png"
                                                alt="boxed" class="mode dark-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                            <img src="{{ asset('dashboard') }}/assets/images/settings/light/09.png"
                                                alt="boxed" class="mode light-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                        </label>
                                    ...
                                    <div data-setting="radio" class="text-center">
                                        ...
                                        <label class="btn btn-border position-relative p-0 d-block overflow-hidden"
                                            for="text-hover">
                                            <img src="{{ asset('dashboard') }}/assets/images/settings/dark/14.png"
                                                alt="boxed" class="mode dark-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                            <img src="{{ asset('dashboard') }}/assets/images/settings/light/14.png"
                                                alt="boxed" class="mode light-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                        </label>
                                    ...
                                    <div data-setting="radio" class="text-center">
                                        ...
                                        <label class="btn btn-border position-relative p-0 d-block overflow-hidden"
                                            for="navs-full-width">
                                            <img src="{{ asset('dashboard') }}/assets/images/settings/dark/15.png"
                                                alt="boxed" class="mode dark-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                            <img src="{{ asset('dashboard') }}/assets/images/settings/light/15.png"
                                                alt="boxed" class="mode light-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                        </label>
                                ...
                                <div class="d-grid gap-3 grid-cols-4 mb-4">
                                    <div data-setting="radio" class="text-center">
                                        ...
                                        <label class="btn btn-border p-0 d-block overflow-hidden" for="nav-glass">
                                            <img src="{{ asset('dashboard') }}/assets/images/settings/dark/10.png"
                                                alt="hover" class="mode dark-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                            <img src="{{ asset('dashboard') }}/assets/images/settings/light/10.png"
                                                alt="hover" class="mode light-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                        </label>
                                    ...
                                    <div data-setting="radio" class="text-center">
                                        ...
                                        <label class="btn btn-border p-0 d-block overflow-hidden"
                                            ...
                                            <img src="{{ asset('dashboard') }}/assets/images/settings/dark/12.png"
                                                alt="boxed" class="mode dark-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                            <img src="{{ asset('dashboard') }}/assets/images/settings/light/12.png"
                                                alt="boxed" class="mode light-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                        </label>
    ...
    <script src="{{ asset('dashboard') }}/assets/js/core/libs.min.js"></script>
    <!-- Plugin Scripts -->
    <!-- Tour plugin Start -->
    <script src="{{ asset('dashboard') }}/assets/vendor/sheperd/dist/js/sheperd.min.js"></script>
    <script src="{{ asset('dashboard') }}/assets/js/plugins/tour.js" defer></script>

    <!-- Flatpickr Script -->
    <script src="{{ asset('dashboard') }}/assets/vendor/flatpickr/dist/flatpickr.min.js"></script>
    <script src="{{ asset('dashboard') }}/assets/js/plugins/flatpickr.js" defer></script>



    <!-- Slider-tab Script -->
    <script src="{{ asset('dashboard') }}/assets/js/plugins/slider-tabs.js"></script>


    <!-- fslightbox Script -->
    <script src="{{ asset('dashboard') }}/assets/js/plugins/fslightbox.js" defer></script>




    <!-- Select2 Script -->
    <script src="{{ asset('dashboard') }}/assets/js/plugins/select2.js" defer></script>




    <!-- Lodash Utility -->
    <script src="{{ asset('dashboard') }}/assets/vendor/lodash/lodash.min.js"></script>
    <!-- Utilities Functions -->
    <script src="{{ asset('dashboard') }}/assets/js/iqonic-script/utility.min.js"></script>
    <!-- Settings Script -->
    <script src="{{ asset('dashboard') }}/assets/js/iqonic-script/setting.min.js"></script>
    <!-- Settings Init Script -->
    <script src="{{ asset('dashboard') }}/assets/js/setting-init.js"></script>
    <!-- External Library Bundle Script -->
    <script src="{{ asset('dashboard') }}/assets/js/core/external.min.js"></script>
    <!-- Widgetchart Script -->
    <script src="{{ asset('dashboard') }}/assets/js/charts/widgetcharts.js?v=1.4.1" defer></script>
    <!-- Dashboard Script -->
    <script src="{{ asset('dashboard') }}/assets/js/charts/dashboard.js?v=1.4.1" defer></script>
    <!-- Hopeui Script -->
    <script src="{{ asset('dashboard') }}/assets/js/kivicare.js?v=1.4.1" defer></script>
    <script src="{{ asset('dashboard') }}/assets/js/kivicare-advance.js?v=1.4.1" defer></script>
    <script src="{{ asset('dashboard') }}/assets/js/sidebar.js?v=1.4.1" defer></script>

    <!-- Icons -->
    <script src="{{ asset('dashboard') }}/assets/js/solid-icon-search-filter.js?v=1.4.1" defer></script>
</body>
