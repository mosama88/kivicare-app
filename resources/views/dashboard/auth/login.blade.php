...
<head>
    ...
    <meta name="keywords"
        content="premium, admin, dashboard, template, bootstrap 5, clean ui, Kivicare, admin dashboard,responsive dashboard, optimized dashboard, simple auth">
    <meta name="author" content="Iqonic Design">
    <meta name="DC.title" content="KiviCare Simple | Clinic And Patient Management Dashboard">
    <!-- Config Options -->
...
<body class=" ">
    ...
    <div class="wrapper">
        ...
        <div class="login-content"
            style="background: url(../assets/images/dashboard/sign-in.jpg); background-size: cover;background-repeat: no-repeat;">
            <div class="container">
                    ...
                    <div class="col-lg-5 col-md-12 align-self-center">
                        <div class="card p-0 mb-0">
                            <div class="card-body auth-card">
                                <div class="logo-img">
                                    <a href="../index.html"
                                        class="navbar-brand d-flex align-items-center justify-content-center mb-5">
                                        ...
                                        <div class="logo-main">
                                            ...
                                            <img class="logo-normal dark-normal img-fluid"
                                                src="{{ asset('dashboard') }}/assets/images/logo-dark.png"
                                                height="30" alt="logo">
                                            <img class="logo-normal white-normal img-fluid"
                                                src="{{ asset('dashboard') }}/assets/images/logo-white.png"
                                                height="30" alt="logo">
                                            <img class="logo-mini img-fluid"
                                                src="{{ asset('dashboard') }}/assets/images/logo-mini.png"
                                                height="30" alt="logo">
                                            <img class="logo-mini dark-mini img-fluid"
                                                src="{{ asset('dashboard') }}/assets/images/logo-mini-dark.png"
                                                height="30" alt="logo">
                                            <img class="logo-mini white-mini img-fluid"
                                                src="{{ asset('dashboard') }}/assets/images/logo-mini-white.png"
                                                height="30" alt="logo">
                                        </div>
                                        <!--logo End-->
                                    </a>
                                ...
                                <form method="POST" action="{{ route('dashboard.login') }}">
                                    ...
                                    <div class="custom-form-field mb-3">
                                        ...
                                        <input type="text" name="username" value="{{ old('username') }}"
                                            class="form-control @error('username') is-invalid @enderror mb-5"
                                    ...
                                    <div class="custom-form-field mb-3">
                                        ...
                                        <input type="password" name="password"
                                            class="form-control @error('password') is-invalid @enderror mb-5">
                                        @error('password')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
