                        ...
                        <ul class="navbar-nav iq-nav-menu  list-unstyled" id="header-menu">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="sub-nav collapse  list-unstyled" id="allPages">
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="collapse" href="#docPages" role="button"
                                            aria-expanded="false" aria-controls="docPages">
                                        ...
                                        <ul class="sub-nav collapse  list-unstyled" id="docPages">
                                            <li class="nav-item">
                                                <a class="nav-link " href="{{ asset('website') }}/tab-two-column.html">
                                                    tab two column
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link " href="{{ asset('website') }}/doctor-details.html">
                                                    doctor details
                                                </a>
                                            </li>
                                        </ul>
