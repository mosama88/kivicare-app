                    ...
                    <form action="{{ url('/website/change-language/en') }}" method="GET">
                        <div data-setting="attribute" class="text-center w-100">
                            ...
                            <button type="submit" class="btn dir-btn cutomizer-button w-100"
                                for="theme-scheme-direction-ltr">English</button>
                        </div>
                    </form>
                </div>
                <div class="col">
                    <form action="{{ url('/website/change-language/ar') }}" method="GET">
                        <div data-setting="attribute" class="text-center w-100">
                            ...
                            <button type="submit" class="btn dir-btn cutomizer-button w-100"
                                for="theme-scheme-direction-rtl">العربية</button>
                        </div>
                    </form>
                </div>
                ...
                <div class="col">
                    <div data-setting="attribute" class="text-center w-100">
                        ...
                        <label class="btn dir-btn cutomizer-button w-100" for="theme-scheme-direction-ltr">
                            <a href="{{ url('/dashboard/change-language/en') }}">English</a>
                        </label>
                    </div>
                </div>
                <div class="col">
                    <div data-setting="attribute" class="text-center w-100">
                        ...
                        <label class="btn dir-btn cutomizer-button w-100" for="theme-scheme-direction-rtl">
                            <a href="{{ url('/dashboard/change-language/ar') }}">العربية</a>
                        </label>
                    </div>
                </div>
            </div>
