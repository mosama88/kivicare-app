                        ...
                        <div class="no-sub-title big-font">
                            <div class="iq-title-box">
                                ...
                                <h2 class="iq-title iq-heading-title">
                                    <span class="right-text text-capitalize fw-500">{{ __('home.enjoy_The_beauty') }} </span>
                                    <span
                                        class="left-text text-capitalize fw-light">{{ __('home.of_A_Healthy_Smile') }}!</span>
                                </h2>
                                <p class="iq-title-desc text-body mt-3 mb-0">

                                    {{ __('home.of_A_Healthy_Smile_desc') }}
                                </p>
                            </div>
                        </div>
                ...
                <div class="col-lg-6  section-padding">
                    <div class="iq-title-box text-white pe-lg-5 mb-0">
                        ...
                        <h2 class="iq-title iq-heading-title text-white">
                            ...
                            <span class="left-text text-capitalize fw-light">{{ __('home.guaranteed_by_kiviCare') }}</span>
                        </h2>
                        <p class="iq-title-desc text-white pb-4">
                            {{ __('home.guaranteed_by_kiviCare_desc') }}
                        </p>
                        <div class="row">
                            <div class="col-sm-6">
                                <div
            ...
            <div class="row">
                <div class="col-12">
                    <div class="position-relative padding-200 rtl-image-flip"
                        ...
                        <div class="background-overlay position-absolute h-100 w-100 opacity-50 bg-primary top-0 start-0">
                        </div>
    ...
    <div class="position-relative section-padding rtl-image-flip"
        ...
        <div class="container-fluid rtl-image-flip-container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="overflow-hidden tesimonial-quote swiper swiper-general" data-slide="1" data-laptop="1"
